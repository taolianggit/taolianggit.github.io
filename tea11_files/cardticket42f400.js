...
function r(){
if(n())for(var e in b._players){
var t=b._players[e];
if(t.hasBeginPlay()&&t.isPlay()){
t.pause4outer(),b.visibilityPausePlayer=t;
break;
}
}else{
var i=b.visibilityPausePlayer;
i&&i.hasBeginPlay()&&!i.isEnd()&&(i.play4outer(),b.visibilityPausePlayer=null);
}
}
function s(e){
...
v.proxyPreloadExper())){
var t=parseInt(e.__firstPlayEnd-e.__firstPlayStart),i=y.toBase64(JSON.stringify({
scene:window.source,
...
t();
var P=function(e){
b._debug&&console.log(e);
},j=navigator.userAgent,C=function(){
return!0;
}(),B=-1!==j.indexOf("Safari")&&-1!==j.indexOf("Version")&&-1==j.indexOf("Android"),k=function(){
return!!_.browser.M1;
}(),F=function(e,t){
...
},D=!_.canSupportVideo,M=function(e){
var t=$(e.container);
...
.1>=a&&(i.needToFit=!0,F("objectFit","fill")&&(i.supportObjectFit=!0,e.videoFit=!0));
}
...
this.__loadingCountFlag=null,this._g={
...
},e._mustHideFullScreen=k,e.display=e.autoHide?"none":"block",e.ad_muted_btn=e.ad_muted_btn||!1;
var n=c.tmpl(u,e);
t.append(n);
...
if(r.setAttribute("origin_src",s),D)return o.find(".js_btn_play").attr("href",s).show(),
this.__loadedHandler(),void this.__bindBtnEvent();
var d=e.plugins||[];
this._blockPlugin={};
for(var l=0,h=d.length;h>l;++l){
var p=d[l];
...
b._players[this.id]=this;
};
return $.extend(M.prototype,{
...
var o=e["on"+i];
"function"==typeof o&&o.apply(this,t),"BeginPlay"!=i||null!=a.__replaySec&&0!=a.__replaySec||!_.os.ios||(n.currentTime=.1);
}
},
...
if(e&&e.autoplay&&!B)return void this._trigger("readyBeginPlay",e);
this.hideLoading(),this.container.find(".js_video_play_controll").css({
display:"block"
});
var t=this.opt.duration;
if(t&&t>0&&this.container.find(".js_video_length").html(x(t)).show(),1==this.__iosPreloadPause){
var i=this;
setTimeout(function(){
...
e.muted&&o(t,!0),this.$video.off("loadedmetadata durationchange"),this.__hasVideoDurationchange=!1;
},
...
e.log.duration=e.duration,e.duration=e.duration>>0,a.find(".js_total_time").text(x(e.duration)),
this.__hasFuncControllBar&&a.find(".js_progress_bar,.js_total_time").show();
...
n=t.video,null!=t.__replaySec&&(P(t.id+":timeupdate __replaySec"),n.pause(),n.currentTime=t.__replaySec,
...
t.showLoading(),t.showCover(),n.pause(),n.src=e,n.load(),n.play(),P(t.id+":stalled"));
}
}),e.on("seeked",function(){
t.__onTouch||(t.changeStatus({
status:"loading",
subStatus:"seeked"
}),n.play()),t.__seeking=!1,P("video seeked event");
...
},w),clearTimeout(t.waitingHandlerTimer),t.waitingHandlerTimer=null;
var e=0;
for(var i in b._players)if(b._players.hasOwnProperty(i)&&e++,e>1)break;
...
var i=n.src;
t.showLoading(),t.showCover(),n.pause(),n.src=i,o++,n.load(),n.play(),P(t.id+":waitingHandlerTimer");
}
}
...
},10),P(t.id+":play playing"),a.removeClass("switch_on"),a.addClass("switch_off"),
...
},10),a.addClass("switch_on"),a.removeClass("switch_off"),!t.__canplay||t.isEnd()||t.__onTouch?t._hidePlayControllBar():(t.hideControllBar(!0),
...
function e(){
if(i.__userplaytime=!0,D)return location.href=i.opt.src,!1;
if(i.changeStatus({
status:"loading",
subStatus:"preload"
}),n){
...
o.find(".js_btn_play")),s=o.find(".js_btn_play_aria"),d=o.find(".js_video_poster"),u=o.find(".js_switch"),c=o.find(".js_progress_bar"),p=o.find(".js_controll"),g=(o.find(".js_played_bar"),
...
l.on(v[0],"tap",".js_btn_pause",function(){
i.play4outer();
});
var w,b,T,S,P=0,j=!1,B=0,k=0,F=i.__getDuration(),x=0,M=1,H=window.user_uin||0,E=0!==H&&Math.floor(H/100)%1e3<M,I=!1,z=0;
g.on("touchstart",function(e){
1==e.targetTouches.length&&i.isPlay()&&(a.blockTouchVideo||(T=w=new Date,S=b={
x:e.targetTouches[0].clientX,
y:e.targetTouches[0].clientY
},x=i.getCurTime(),_.os.android&&e.preventDefault()));
...
if(S.x==b.x&&S.y==b.y&&Math.abs(o-S.y)>=10)return void(j=!1);
var r=t-w,s=n-b.x,d=o-b.y,l=Math.sqrt(Math.pow(s,2)+Math.pow(d,2))+k,u=Math.min(Math.ceil(l/r),6);
B=Math.floor(.1*l+.2*u*u*u)*Math.ceil(F/500),k=0==B?l:0,0>s&&(B=-B);
var _=180*Math.atan2(d,s)/Math.PI;
j||(_>=-30&&30>=_&&++P,(_>=150&&180>=_||_>=-180&&-150>=_)&&--P,(P>=4||-4>=P)&&(5>=l?P=0:(z=Math.max(z,u),
j=!0))),j&&(x+=B,0>x&&(x=0),x>F&&(x=1*F),i.__setForwardBar(x),e.preventDefault(),
e.stopPropagation()),b={
x:n,
y:o
},w=t;
...
if(j){
if(i.play(x),o.find(".js_forward").css("display","none"),E&&((new Image).src="/mp/jsmonitor?idkey=28307_29_1",
!I)){
var t=(new Date,{
...
i.isInFullScreen()&&!C&&(e.preventDefault(),e.stopPropagation());
}),l.tap(g[0],function(e){
...
d.off("mousemove",i._event.progressBarMousemove).on("mousemove",i._event.progressBarMousemove),
...
}),l.tap(m[0],function(e){
return i.isInFullScreen()?C&&i.exitFullScreen():C&&((new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=28307_56_1&r="+Math.random(),
...
(d||l>=.5)&&(this.progressBarSeekData.dragTime=s,P("_pointerMoveHandler set currentTime, dragTime:"+this.progressBarSeekData.dragTime+" currentTime:"+this.video.currentTime),
...
this.container.find(".js_now_play_time").text(x(e));
},
...
t.find(".js_forward").css("display","block"),t.find(".total_time").text(x(i)),t.find(".js_forward_bar").css("width",100*a+"%"),
t.find(".js_forward_play_time").text(x(e));
},
...
try{
var n="",r=Object.prototype.toString.call(t);
n="[object String]"===r?t:"[object Object]"===r||"[object Array]"===r?JSON.stringify(t):"no params",
this._jsapiLog("trigger:"+e+";arg:"+n+";");
}catch(s){}
}
if("readyBeginPlay"==e&&(a.__iosPreloadPlayFlag=!1),"play"==e&&0==a.__iosPreloadPlayFlag){
if(console.log("trigger real play"),a.__iosIsRealPreload&&o(a.video,!1),a.__forcePause=!1,
a._trigger("userplay"),a.opt.notPauseOtherVideoWhenPlay||p.broadcastMessage({
type:"broadcastPlay",
data:{
id:this.id
}
}),window.parent.originalVideoAdFrames&&0!=window.parent.originalVideoAdFrames.length)for(var d=0;d<window.parent.originalVideoAdFrames.length;d++)window.parent.originalVideoAdFrames[d].contentWindow.postMessage({
action:"pauseAd",
value:""
},"*");
...
var l=this.plugins,u=this._blockPlugin[e]||this._blockPlugin.all,_=0;
if(u&&"function"==typeof u.recv&&(_|=u.recv(e,t),1&_))return!1;
for(var d=0,h=l.length;h>d&&(_|=l[d].recv(e,t),!(2&_));++d);
...
var a=this,n=this.$video,r=(this.opt,this.video);
this.src=e,(!a.__iosPreloadPause||i)&&a.__initData(),a.__initVideo(),this.showCover(),
a.log.loadwait_start=+new Date,(!n.attr("src")||i)&&(n.attr("src",e),v.proxyPreloadExper()&&v.proxyPreloadExper().isUsePreload&&_.os.ios&&!a.opt.ad_muted_btn&&!function(){
var e=function t(){
a.__iosPreloadPause=!0,r.pause(),a._trigger("ready",a.opt),r.removeEventListener("canplay",t,!1);
};
r.addEventListener("canplay",e,!1),4!==r.readyState&&(a.__iosPreloadPlayFlag=!0,
a.__iosIsRealPreload=!0,o(r,!0),r.play());
}()),r.preload=t||"metadata",n.on("loadedmetadata",function(){
if(a.__videoDurationchange(),a.__playQueue&&a.__playQueue.length>0){
var e=a.__playQueue[0].sec;
a.__playQueue=[],a.play(e);
}
}),r.duration>0&&1!=r.duration&&a.__videoDurationchange();
},
replay:function(){
_.os.android;
...
this._jsapiLog(n),P(n),p.broadcastMessage({
type:"statusChange",
data:{
id:this.id,
preStatus:i,
...
e?(o(this.video,!0),this.container.find(".js_muted_btn").addClass("muting")):(o(this.video,!1),
...
try{
delete b._players[this.id];
}catch(e){}
b.visibilityPausePlayer===this&&(b.visibilityPausePlayer=null);
}
}),M._getFormatTime=x,M;
