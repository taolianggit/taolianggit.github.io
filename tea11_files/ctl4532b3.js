...
});define("pages/qqmusic_ctrl.js",["biz_common/utils/monitor.js","pages/player_adaptor.js","biz_wap/jsapi/log.js","biz_wap/utils/ajax.js"],function(e){
"use strict";
function r(e,r){
...
var u,p=i.songlist[0],l=p.song_play_url,d=p.song_play_time||0;
if(p.playable)u=l?0:6;else if(p.try_playable)p.try_file_size>0&&p.try_30s_url?(u=8,
l=p.try_30s_url,d=30):u=7;else switch(1*p.unplayable_code){
case 1:
u=1;
break;
...
var i=e("biz_common/utils/monitor.js"),c=e("pages/player_adaptor.js"),n=e("biz_wap/jsapi/log.js"),m=e("biz_wap/utils/ajax.js"),u={
