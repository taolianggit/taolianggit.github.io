...
e.style.display="none",_=-1;
},100));
}
window.reportWeappid=[];
for(var r=0;r<E.length;r++)window.reportWeappid.push(E[r].appid);
var d=function(){};
g.on(document.getElementById("js_minipro_dialog_ok"),"click",function(){
document.querySelector("body").removeEventListener("touchmove",e),d&&d(),document.getElementById("js_minipro_dialog").style.display="none";
...
var s,_,b=!y.canJumpOnTap||y.isNonWechat,I=document.getElementById("js_pc_weapp_code"),j=document.getElementById("js_pc_weapp_code_img"),k=document.getElementById("js_pc_weapp_code_des");
b&&(g.on(I,"mouseenter",function(){
clearTimeout(s);
...
var R=E.data.infoMap;
if(R){
for(r=0;r<C.length;r++)(function(r){
window.__addIdKeyReport("111535",1);
var v=C[r].appid,E=C[r].path,x=C[r].imageUrl,T=C[r].title,B=C[r].elem,K=R[v];
if(K){
var z=B.tagName.toLowerCase(),A=B.firstChild&&1==B.firstChild.nodeType&&"IMG"===B.firstChild.tagName;
if(A=A||B.firstElementChild&&"IMG"===B.firstElementChild.tagName,"a"!=z)B.innerHTML=w.tmpl(f,{
imageUrl:i(x),
title:i(T),
nickname:i(K.nickname),
avatar:i(K.logo_url)
});else{
if(A){
var N=B.firstChild;
N&&h.addClass(B,"weapp_image_link");
}else h.addClass(B,"weapp_text_link");
B.setAttribute("href","");
}
g.on(B,"tap",function(){
if(d=function(){
...
p(v,r,K.nickname,T,e);
},
beforeJumpBackupPage:function(){
a(v,r,K.nickname,T,e);
},
...
}),window.__addIdKeyReport&&window.__addIdKeyReport("28307",100),n(v,r,K.nickname,T,3,e,A?2:0),
A&&window.__addIdKeyReport&&window.__addIdKeyReport("28307",115),!1;
},A&&img_popup){
document.getElementById("js_minipro_dialog_name").innerText='即将打开"'+K.nickname+'"小程序';
...
passive:!1
}),o._appid=v,o._i=r,o._nickname=K.nickname,o._title=T,n(v,r,K.nickname,T,3,1,0),
y.canJumpOnTap&&window.__addIdKeyReport&&window.__addIdKeyReport("28307",114),!1;
}
return d();
},"a"==z),g.on(B,"click",function(e){
e.preventDefault(),e.stopPropagation();
},"a"==z),b&&(g.on(B,"mouseenter",function(){
function e(e){
function t(){
if(!g&&_===r){
I.style.display="block",g=!0;
var e=I.offsetHeight,t=I.offsetWidth;
"a"!=z||A?n>t?(c(I,"right-center"),I.style.left=n-t-f+"px",I.style.top=o+"px"):(c(I),
I.style.top=o+s-e-f+"px",I.style.left=n+d-t-f+"px"):(I.style.left=i>n+d/2-t/2?i+"px":n+d/2+t/2>i+a?i+a-t+"px":n+d/2-t/2+"px",
p>e?(c(I,"down-center"),I.style.top=o-e-f+"px"):(c(I,"up-center"),I.style.top=o+s-f+"px"));
}
}
if(e){
var n=l(B),o=m(A?B.firstElementChild:B),i=l(B.parentNode),a=B.parentNode.offsetWidth,p=B.getBoundingClientRect().top,d=A?B.firstElementChild.offsetWidth:B.offsetWidth,s=A?B.firstElementChild.offsetHeight:B.offsetHeight,f=8,g=!1;
k.innerText=u(K.nickname,48),j.onload=t,j.src=e,(j.complete||j.width)&&t();
}
}
clearTimeout(s),_!==r&&(I.style.display="none",_=r,y.getAppidCode({
appid:v,
path:E
},e));
...
},0),n(x[e].appid,e,R[x[e].appid].nickname,x[e].title,2,a),x.splice(e--,1));
}
};
B(),g.on(window,"scroll",function(){
T||(T=setTimeout(B,100));
});
}
},
onError:function(e){
...
video_iframe:[],
video_top:[]
},m=e("pages/version4video.js"),a=e("biz_common/dom/attr.js"),p=(a.setProperty,e("biz_common/dom/event.js")),l=document.getElementsByTagName("iframe"),_=[];
/MicroMessenger/.test(navigator.userAgent);
}
window.reportVid=[];
for(var u=Math.ceil(1e4*Math.random()),w=0,v=l.length;v>w;++w)!function(e){
...
dom:e,
vid:w
}),d=["/mp/videoplayer?video_h=",f,"&video_w=",v,"&scene=",window.source,"&random_num=",u,"&article_title=",encodeURIComponent(window.msg_title.htmlDecode()),"&source=4&vid=",w,"&mid=",appmsgid,"&idx=",itemidx||idx,"&__biz=",biz,"&nodetailbar=",window.is_temp_url?1:0,"&uin=",uin,"&key=",key,"&pass_ticket=",pass_ticket,"&version=",version,"&devicetype=",window.devicetype||"","&wxtoken=",window.wxtoken||"","&sessionid=",window.sessionid||"","&preview=",window.is_temp_url?1:0].join(""),
...
f:"html",
success:function(o){
e.contentWindow.document.open("text/html","replace"),e.contentWindow.document.write(o),
...
var x=i.indexOf("#wechat_redirect")>-1,y=["&uin=",uin,"&key=",key,"&pass_ticket=",pass_ticket,"&wxtoken=",window.wxtoken||""].join("");
reprint_ticket?y+=["&mid=",mid,"&idx=",idx,"&reprint_ticket=",reprint_ticket,"&source_mid=",source_mid,"&source_idx=",source_idx,"&appmsg_token=",appmsg_token].join(""):o.indexOf("vote_iframe")>=0&&(y+=["&mid=",mid,"&idx=",idx,"&appmsg_token=",appmsg_token].join(""));
var h=x?i.replace("#wechat_redirect",y):i+y;
window.__second_open__?n({
url:h,
type:"GET",
f:"html",
success:function(o){
e.contentWindow.Ajax=n,e.contentWindow.document.open("text/html","replace"),e.contentWindow.document.write(o),
e.contentWindow.document.close(),e.contentWindow.history.replaceState(null,null,h),
-1==i.indexOf("mp.weixin.qq.com/mp/getcdnvideourl")&&(e.onload=function(){
t(e);
});
...
var b=v,j=3*b/4;
e.width=b,e.height=j,e.style.setProperty&&(e.style.setProperty("width",b+"px","important"),
...
});define("appmsg/outer_link.js",["biz_common/dom/event.js","appmsg/open_url_with_webview.js","biz_wap/jsapi/core.js","biz_wap/utils/mmversion.js","biz_wap/utils/ajax.js"],function(e){
"use strict";
function t(e){
e.preventDefault();
}
...
var n=e.container;
if(!n)return!1;
for(var c=n.getElementsByTagName("a")||[],l=0,u=c.length;u>l;++l)!function(n){
var l=c[n],u=l.getAttribute("href");
if(!u)return!1;
var _=0,d=l.innerHTML;
/^[^<>]+$/.test(d)?_=1:/^<img[^>]*>$/.test(d)&&(_=2);
var f=l.getAttribute("data-linktype"),y=l.getAttribute("href");
!!e.changeHref&&!/^https?:\/\/mp\.weixin\.qq\.com\/cgi-bin\//.test(u)&&(u=e.changeHref(u,_)),
i.on(l,"tap",function(e){
e.preventDefault();
var n="";
s[l.getAttribute("data-itemshowtype")]&&(n=s[l.getAttribute("data-itemshowtype")]);
var i=document.getElementById("js_link_dialog_name");
if(i.innerText="即将打开新的页面",a[y]&&a[y].subject_name&&"0"===a[y].item_show_type&&a[y].title?i.innerText='即将打开公众号 "'+a[y].subject_name+'" 的'+s[a[y].item_show_type]+"《"+a[y].title+"》":a[y]&&a[y].subject_name&&a[y].item_show_type>=0&&(i.innerText='即将打开公众号 "'+a[y].subject_name+'" 的'+s[a[y].item_show_type]),
e.stopPropagation(),"undefined"==typeof p[y]&&(y.indexOf("mp.weixin.qq.com/s/")>-1||y.indexOf("mp.weixin.qq.com/s?")>-1)?(new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=110809_6_1&r="+Math.random():"undefined"==typeof p[y]&&((new Image).src=location.protocol+"//mp.weixin.qq.com/mp/jsmonitor?idkey=110809_7_1&r="+Math.random()),
p=function(){
return a[y]&&a[y].item_show_type>=0&&u.indexOf("mp.weixin.qq.com")>-1&&(m.isIOS||m.isAndroid)&&!m.isInMiniProgram?1==l.getAttribute("clicked")?!1:(r.invoke("openWebViewUseFastLoad",{
url:u,
...
}),!1):void(m.isAndroid||m.isIOS?o(u,{
sample:1,
reject:function(){
location.href=u;
}
...
var c=document.getElementById("js_link_dialog");
c.style.display="block",document.querySelector("body").addEventListener("touchmove",t,{
passive:!1
});
}else p();
return!1;
...
var i=e("biz_common/dom/event.js"),o=e("appmsg/open_url_with_webview.js"),r=e("biz_wap/jsapi/core.js"),m=e("biz_wap/utils/mmversion.js"),s=(e("biz_wap/utils/ajax.js"),
{
0:"文章",
11:"文章",
8:"图片",
...
if("undefined"!=typeof jumpInfo)for(var c=0;c<jumpInfo.length;c++)a[jumpInfo[c].url]={
title:jumpInfo[c].title,
item_show_type:jumpInfo[c].item_show_type,
subject_name:jumpInfo[c].subject_name,
link_type:jumpInfo[c].link_type
};
var p=function(){};
return i.on(document.getElementById("js_link_dialog_ok"),"click",function(){
document.querySelector("body").removeEventListener("touchmove",t),p&&p(),document.getElementById("js_link_dialog").style.display="none";
}),i.on(document.getElementById("js_link_dialog_cancel"),"click",function(){
