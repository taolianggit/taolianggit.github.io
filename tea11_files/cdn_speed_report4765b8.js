...
this.aInfoMap[e.aid].aInfo.pos_type!==AD_POS.POS_BOTTOM||this.hasReportBottomTime||(monitor.setAvg(112287,38,Date.now()-window.logs.pagetime.page_begin),
monitor.setAvg(112287,40,Date.now()-t.createIframeTime),monitor.send(),this.hasReportBottomTime=!0);
}
...
i.initAdBeforeVideo(e),void(window.__second_open__||utils.report115849(118))):e.pos_type===AD_POS.POS_BOTTOM?void i.initBottomAd(e):e.pos_type===AD_POS.POS_AD_AFTER_VIDEO?(i.hasAdAfterVideo=!0,
